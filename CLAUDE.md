...
| `houses/les-abstraits.html` | **Les Abstraits**, the sixth house: four fragrances, written, all four with notes off the house's own page — with a **drawing** of Des Cendres' road standing in its writing, and a **last word** at the foot whose link opens a new window; on iris paper, with an **armoire** of specks in the left margin, iris in it, and a slow **drip** down the right margin the whole length of the page into a **beaker** at its foot, drawn as a diagram, which overflows | `search.js`, `house.js`, `beaker.js`, `abstraits.js`, `notes-data.js`, `notes.js` | [the newer houses](docs/features/2026-09-21-the-newer-houses.md) |
