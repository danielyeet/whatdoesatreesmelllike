...
yourself; ask only about the whole and the look.** When an instruction is genuinely
uncertain about what the round adds up to or about a stylistic detail, ask with the
...
| `houses/les-abstraits.html` | **Les Abstraits**, the sixth house: four fragrances, written, all four with notes off the house's own page — with a **drawing** of Des Cendres' road standing in its writing, and a **last word** at the foot whose link opens a new window; on iris paper, with an **armoire** of specks in the left margin, iris in it, and a **drip** in the right filling a **puddle** | `search.js`, `house.js`, `abstraits.js`, `notes-data.js`, `notes.js` | [the newer houses](docs/features/2026-09-21-the-newer-houses.md) |
