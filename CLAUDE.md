...
(~780), `paper.js` (~580), `essay.js` (~430), `pineward-gallery.js` (~350),
`index-page.js` (~310), `thread.js` (~290), `search.js` (~270), `extras.js` (~250),
`views.js` (~240), `landing.js` (~230), `nav.js` (~220), `search-page.js` (~190),
`photography.js` (~190), `find-ground.js` (~180) and `page-search.js` (~110).
