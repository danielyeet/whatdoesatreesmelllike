...
**A clean run is 190 passed, 0 failed, and takes seven to ten minutes.** If you get a
...
| **the sun** / **the rain** / **the chair** (Almost Human) | The three things on that page that are not people, all drawn in the same specks and all answering the hand the same way: a sun that is a **ring** with uneven rays, standing above the crowd; **rain** falling the length of the page, each drop a short string of specks; and **an empty chair**, one for every three figures. They stray far less than a person does (`PROP_STRAY`), because you are meant to be able to see what they are. |
